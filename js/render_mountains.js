...
class MountainsRenderer {
    ...
    createMountainCard(mountain, index) {
        ...
        card.innerHTML = `
            <div class="card-image">
                <img src="${mountain.image}" alt="${mountain.name}" loading="lazy" onerror="this.src='./img/mountains/dawoud.jpg'">
    ...
    showModal(mountain) {
        ...
        if (modalImage) {
            modalImage.src = mountain.image;
            modalImage.onerror = function() { this.src = './img/mountains/dawoud.jpg'; };
        }
